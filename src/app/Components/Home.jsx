  ...
  return (
    <section id="home" className="h-[90vh] m-auto w-9/12 py-5 grid grid-cols-3">
      ...
      <div className="col-span-2  flex flex-col">
        ...
        <p className="text-[80px] font-bold">FOUNDER & CEO</p>
        ...
        <button className="text-sm bg-gradient-to-r from-[#9F1089] to-[#593CC2] w-[200px] text-white p-3 mt-4 ml-10 rounded-lg cursor-pointer">
          Explore Me
        </button>
      </div>
